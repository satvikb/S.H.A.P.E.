...
class MainMenu : UIView{
    ...
    override init(frame: CGRect) {
        ...
        titleLabel = Label(frame: CGRect(origin: Screen.getScreenPos(x: 0.1, y: 0.1), size: Screen.getScreenSize(x: titleLabelSize.width, y: titleLabelSize.height)), text: "S.H.A.P.E.", _outPos: /*Screen.getScreenPos(x: 0.1, y: -0.3)*/Screen.getScreenPos(x: 0.5-(titleLabelSize.width/2), y: 1+buttonHeight), _inPos: Screen.getScreenPos(x: 0.1, y: 0.1), textColor: UIColor.green)
...
//            UIColor.black//UIColor(red: 0.168627451, green: 0.168627451, blue: 0.168627451, alpha: 1)
            
//            let color = GameController.sharedInstance.viewController.view.backgroundColor == UIColor.black;
            GameController.sharedInstance.viewController.view.backgroundColor = UIColor(red: 0.168627451, green: 0.168627451, blue: 0.168627451, alpha: 1)//color ? UIColor.black : UIColor(red: 0.168627451, green: 0.168627451, blue: 0.168627451, alpha: 1)
        }
