...
class Gameplay {
    ...
    //single player
    static let spTimerTime: CGFloat = 2.5
    static let spMinTime: CGFloat = 2
    static let spReduceTime: CGFloat = 0.01
    static let spCompareWidth: CGFloat = Screen.getScreenSize(x: 0.03, y: 0).width
    
    //multi player
    static let mpTimerTime: CGFloat = 2.5
    static let mpMinTime: CGFloat = 2
    static let mpReduceTime: CGFloat = 0.01
    static let mpCompareWidth: CGFloat = Screen.getScreenSize(x: 0.03, y: 0).width
